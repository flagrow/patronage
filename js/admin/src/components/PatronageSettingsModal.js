  ...
  form() {
    ...
    return [
      <div className="Form-group">
        <label>{app.translator.trans('flagrow-patronage.admin.settings.client_id_label')}</label>
        <input className="FormControl" bidi={this.setting('flagrow-patronage.client_id')}/>
      </div>,

      <div className="Form-group">
        <label>{app.translator.trans('flagrow-patronage.admin.settings.client_secret_label')}</label>
        <input className="FormControl" bidi={this.setting('flagrow-patronage.client_secret')}/>
      </div>,

      <div className="Form-group">
        <label>{app.translator.trans('flagrow-patronage.admin.settings.patron_group')}</label>
